Audio Morse Cipher - Puzzle #1

Files included:
- morse_CODE.wav             : audio file encoding the secret word in Morse code.
...
Hint: 4-letter word. What programmers write.
...
- Audio duration of this puzzle: 4.68 s

How to decode (beginner, using only your ears):
1. Play morse_CODE.wav (double-click or use any media player).
...
2. Open morse_CODE.wav in Audacity.
