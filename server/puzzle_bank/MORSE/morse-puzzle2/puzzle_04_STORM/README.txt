Audio Morse Cipher - Puzzle #4

Files included:
- morse_STORM.wav             : audio file encoding the secret word in Morse code.
...
Hint: 5-letter word. Wild weather event.
...
1. Play morse_STORM.wav (double-click or use any media player).
...
2. Open morse_STORM.wav in Audacity.
