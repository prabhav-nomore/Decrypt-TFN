Audio Morse Cipher - Puzzle #2

Files included:
- morse_FIRE.wav             : audio file encoding the secret word in Morse code.
...
Hint: 4-letter word. Hot and bright.
...
- Audio duration of this puzzle: 3.48 s

How to decode (beginner, using only your ears):
1. Play morse_FIRE.wav (double-click or use any media player).
...
2. Open morse_FIRE.wav in Audacity.
